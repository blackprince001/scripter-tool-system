...
async def create_story(story: Story, db: FirestoreDatabase):
    try:
...
async def get_story(story_id: str, db: FirestoreDatabase):
...
async def update_story(story_id: str, update_data: StoryUpdate, db: FirestoreDatabase):
...
async def delete_story(story_id: str, db: FirestoreDatabase):
